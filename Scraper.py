...
column2 = [99.7, 99.3, 97.6, 93.1, 88.0, 81.6, 75.0, 66.9, 59.3, 51.6, 44.1, 37.4, 31.3, 25.5, 20.6, 16.2, 12.2, 8.9, 6.3, 4.2, 2.7, 1.6, 0.6, 0.2, 0.04]
...
for i in peak_rating:
    ...
    print(rank.text)
    print(season.text+'\n')
    percentage(rank.text.split(),column1,column2)
